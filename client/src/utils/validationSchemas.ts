...
export const registerSchema = z.object({
  ...
  nickname: z.string().min(2, '닉네임은 최소 2자 이상이어야 합니다.').max(30, '닉네임은 최대 30자까지 가능합니다.'),
  colorVisionType: z.enum(['normal', 'protanopia', 'deuteranopia', 'tritanopia', 'monochromacy'] as const),
